...
<div class="wrap">
  ...
  <form name="<?php echo LIBSYN_NS . "form" ?>" method="post" action="">
     <div id="poststuff">
      <div id="post-body">
              ...
              <table class="form-table">
                <tr valign="top">
                  ...
                  <td>
					...
					<input id="podcast_feed_button" type="button" value="check" name="podcast_feed_button" onclick="form.submit();" <?php checked("check", get_option(LIBSYN_NS . "podcast_feed_url")); ?> />		 
                  </td>
                </tr>
              </table>
            </div>
...
<?php  FOREACH($podcasts as $podcast): ?>
                <tr valign="top">
                  ...
                  <td>
					...
					<input id="podcast_delete_button" type="button" value="delete" name="podcast_feed_button" onclick="form.submit();" <?php checked("delete", get_option(LIBSYN_NS . "podcast_delete_button")); ?> />		 
                  </td>
                </tr>
<?php  ENDFOREACH; ?>
              </table>
