...
/*
	...
	$meta_query = "DELETE FROM $wpdb->postmeta WHERE meta_key LIKE '" . LIBSYN_NS . "%';";
	$option_query = "DELETE FROM $wpdb->options WHERE option_name LIKE '" . LIBSYN_NS . "%';";
	...
	update_option(LIBSYN_NS . "uninstalled", true);
